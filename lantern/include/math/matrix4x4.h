	...
	*/
	...
	public:
		...
		*/
		...
		matrix4x4f operator*(matrix4x4f const& m) const;
		...
		*/
		static matrix4x4f translation(float const x, float const y, float const z);
		...
		*/
		static matrix4x4f scale(float const x, float const y, float const z);

		/** Generates uniform scale matrix
		* @param s Scale along each axis
		*/
		static matrix4x4f uniform_scale(float const s);

		/** Generates rotation around x-axis
		* @param radians Radians to rotate for
		*/
		static matrix4x4f rotation_around_x_axis(float const radians);

		/** Generates rotation around y-axis
		* @param radians Radians to rotate for
		*/
		static matrix4x4f rotation_around_y_axis(float const radians);

		/** Generates rotation around z-axis
		* @param radians Radians to rotate for
		*/
		static matrix4x4f rotation_around_z_axis(float const radians);

		/** Generates rotation around specified axis
		* @param axis Axis to rotate around
		* @param radians Radians to rotate for
		*/
		static matrix4x4f rotation_around_axis(vector3f const& axis, float const radians);
		...
		*/
		static matrix4x4f clip_space(float const hfov, float const vfov, float const near, float const far);

		static const matrix4x4f IDENTITY;
	};

	inline vector4f operator*(vector4f const& v, matrix4x4f const& m)
	{
		return vector4f{
