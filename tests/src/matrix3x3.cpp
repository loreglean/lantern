...
TEST(matrix3x3, rotation)
{
	...
	matrix3x3 const m_rotation_around_x_axis{matrix3x3::rotation_around_x_axis(static_cast<float>(M_PI) / 3.0f)};
	...
	matrix3x3 const m_rotation_around_y_axis{matrix3x3::rotation_around_y_axis(static_cast<float>(M_PI) / 10.0f)};
	...
	matrix3x3 const m_rotation_around_z_axis{matrix3x3::rotation_around_z_axis(static_cast<float>(M_PI) / 4.0f)};
	...
	matrix3x3 const m_rotation_around_axis{matrix3x3::rotation_around_axis(axis, static_cast<float>(M_PI) / 2.0f)};
