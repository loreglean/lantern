...
TEST(obj_import, import_obj_mesh)
{
	...
	ASSERT_EQ(faces[0].index1, 1);
	ASSERT_EQ(faces[0].index2, 2);
	ASSERT_EQ(faces[0].index3, 4);
	ASSERT_EQ(faces[1].index1, 5);
	ASSERT_EQ(faces[1].index2, 8);
	ASSERT_EQ(faces[1].index3, 6);
	ASSERT_EQ(faces[2].index1, 1);
	ASSERT_EQ(faces[2].index2, 5);
	ASSERT_EQ(faces[2].index3, 2);
	ASSERT_EQ(faces[3].index1, 2);
	ASSERT_EQ(faces[3].index2, 6);
	ASSERT_EQ(faces[3].index3, 3);
	ASSERT_EQ(faces[4].index1, 3);
	ASSERT_EQ(faces[4].index2, 7);
	ASSERT_EQ(faces[4].index3, 4);
	ASSERT_EQ(faces[5].index1, 5);
	ASSERT_EQ(faces[5].index2, 1);
	ASSERT_EQ(faces[5].index3, 8);
	ASSERT_EQ(faces[6].index1, 2);
	ASSERT_EQ(faces[6].index2, 3);
	ASSERT_EQ(faces[6].index3, 4);
	ASSERT_EQ(faces[7].index1, 8);
	ASSERT_EQ(faces[7].index2, 7);
	ASSERT_EQ(faces[7].index3, 6);
	ASSERT_EQ(faces[8].index1, 5);
	ASSERT_EQ(faces[8].index2, 6);
	ASSERT_EQ(faces[8].index3, 2);
	ASSERT_EQ(faces[9].index1, 6);
	ASSERT_EQ(faces[9].index2, 7);
	ASSERT_EQ(faces[9].index3, 3);
	ASSERT_EQ(faces[10].index1, 7);
	ASSERT_EQ(faces[10].index2, 8);
	ASSERT_EQ(faces[10].index3, 4);
	ASSERT_EQ(faces[11].index1, 1);
	ASSERT_EQ(faces[11].index2, 4);
	ASSERT_EQ(faces[11].index3, 8);
}
