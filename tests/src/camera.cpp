...
TEST(camera, constructor)
{
	...
	camera const c{vector3::ZERO, vector3{2 * cos_value, 0.0f, 2 * sin_value}, vector3::Y_UNIT, (float)M_PI / 2.0f, 0.5f};
...
TEST(camera, moving)
{
	float cos_value = std::cos((float)M_PI/3.0f);
	float sin_value = std::sin((float)M_PI/3.0f);
	camera c{vector3::ZERO, vector3{cos_value, 0.0f, sin_value}, vector3::Y_UNIT, (float)M_PI / 2.0f, 1.0f};
...
{
	camera c{vector3::ZERO, vector3::Z_UNIT, vector3::Y_UNIT, (float)M_PI / 2.0f, 1.0f};
