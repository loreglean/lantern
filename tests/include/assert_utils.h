...
inline void assert_vectors2_near(vector2<float> const& v1, vector2<float> const& v2)
{
	assert_floats_near(v1.x, v2.x);
	assert_floats_near(v1.y, v2.y);
}

inline void assert_vectors3_near(vector3<float> const& v1, vector3<float> const& v2)
{
	assert_floats_near(v1.x, v2.x);
	assert_floats_near(v1.y, v2.y);
